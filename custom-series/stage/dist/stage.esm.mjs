...
var renderItem = function (params, api) {
    ...
    var externalRadius = zrUtil.retrieve2((_a = itemPayload.envelope) === null || _a === void 0 ? void 0 : _a.externalRadius, 6);
    var barVerticalMargin = zrUtil.retrieve2(itemStyle.verticalMargin, 8);
    var barMinWidth = zrUtil.retrieve2(itemStyle.minHorizontalSize, 3);
    var children = [];
    ...
    if (params.dataIndex === params.dataInsideLength - 1) {
        ...
        if (envelope.show !== false && boxes.length > 1) {
            ...
            var opacity = zrUtil.retrieve2(envelope.opacity, 0.25);
